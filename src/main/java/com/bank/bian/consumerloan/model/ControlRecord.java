package com.bank.bian.consumerloan.model;
...
/**
 * The BIAN control record for this service domain: "Consumer Loan Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Consumer Loan Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Consumer Loan Facility Fulfillment Arrangement";
